...
const Hero = () => {
  return (
    <div className="relative h-[500px] bg-[url('https://images.unsplash.com/photo-1514933651103-005eec06c04b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1934&q=80')] bg-cover bg-center">
